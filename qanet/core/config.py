...
_C.MODEL.PARSING_ON = True #False
...
_C.SOLVER.BASE_LR = 0.000062#0.001

# The number of max epochs
_C.SOLVER.MAX_EPOCHS = 140

# Momentum to use with SGDf
_C.SOLVER.MOMENTUM = 0.9

# L2 regularization hyperparameter
_C.SOLVER.WEIGHT_DECAY = 0.0000062#0.0001
...
_C.TRAIN.SELECT_DATA = True #False   # TODO

_C.TRAIN.CALC_ACC = True #False   # TODO
...
_C.TEST.AUG.POST_PROCESS = False #True
...
_C.KEYPOINT.PROB_SIZE = (192, 192) #(48, 64)
...
_C.PARSING.PARSINGIOU_ON = True #False
...
_C.PARSING.PIXEL_SCORE_TH = 0.2 #**very important
...
_C.VIS.SHOW_BOX.ENABLED = True #False
...
# Whether show border
_C.VIS.SHOW_MASK.SHOW_BORDER = False
