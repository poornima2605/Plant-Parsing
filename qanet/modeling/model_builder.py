...
class Generalized_CNN(nn.Module):
    ...
    def parsing_net(self, conv_features, targets=None):
        result_parsing, loss_parsing = self.Parsing(conv_features, targets)
        return result_parsing, loss_parsing
