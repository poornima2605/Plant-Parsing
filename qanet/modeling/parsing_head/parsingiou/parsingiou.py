...
class ParsingIoU(torch.nn.Module):
    ...
    def forward(self, features, parsingiou_targets=None):
        ...
        if self.training:
            ...
            return self._forward_test(parsingiou_pred, parsingiou_targets)
    ...
    def _forward_test(self, parsingiou_pred,parsingiou_targets=None):
        if parsingiou_targets !=None:
            loss_parsingiou = self.loss_evaluator(parsingiou_pred, parsingiou_targets)
        else:
            loss_parsingiou ={}
        return loss_parsingiou, parsingiou_pred[-1]
