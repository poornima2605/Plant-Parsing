...
# =============================================================================
#     # Applying threshold to category scores
#     
#     for i, value in enumerate(category_pixel_scores[0][0]):
#         if value <=0.7:
#             ims_parsings[0][ims_parsings[0] == i+1] = 0
#     
#     category_pixel_scores[0][0][category_pixel_scores[0][0] < 0.7] = 0.0
#     
#     if torch.sum(category_pixel_scores[0][0]) == 0.0:
#         instance_pixel_scores[0] = torch.tensor([0.0])
# =============================================================================
        
    # print("instance",instance_pixel_scores)
    # print("part",category_pixel_scores)
    # print("parsing",torch.unique(ims_parsings[0]))
