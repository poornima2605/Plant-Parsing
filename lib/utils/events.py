...
""".format(
            ...
            val_loss="{:.4f}".format(storage.histories()["val_total_loss"].median(20)),
            val_parsing_loss="{:.4f}".format(storage.histories()["val_parsing_loss"].median(20)),
            val_parsingiou_loss="{:.4f}".format(storage.histories()["val_parsingiou_loss"].median(20)),
...
class EventStorage:
    ...
    def latest_with_smoothing_hint(self, window_size=10):
        """
