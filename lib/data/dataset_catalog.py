...
COMMON_DATASETS = {
    ...
    'Green_AI_train': {
        _IM_DIR:
            _DATA_DIR + '/Green_AI/Training/Images',
        _ANN_FN:
            _DATA_DIR + '/Green_AI/annotations/Green_AI_train.json',
        _FIELDS:
            {'flip_map': ([14, 15], [16, 17], [18, 19]),
             'ignore_label': 255,
             'seg_root': _DATA_DIR + '/Green_AI/Training/Category_ids',
             'label_shift': 0},
    },
    'Green_AI_val': {
        _IM_DIR:
            _DATA_DIR + '/Green_AI/Validation/Images',
        _ANN_FN:
            _DATA_DIR + '/Green_AI/annotations/Green_AI_val.json',
        _FIELDS:
            {'flip_map': ([14, 15], [16, 17], [18, 19]),
             'ignore_label': 255,
             'seg_root': _DATA_DIR + '/Green_AI/Validation/Category_ids',
             'label_shift': 0},
    },
    'Green_AI_test': {
        _IM_DIR:
            _DATA_DIR + '/Green_AI/Testing/Images',
        _ANN_FN:
            _DATA_DIR + '/Green_AI/annotations/Green_AI_test.json',
        _FIELDS:
            {'flip_map': ([14, 15], [16, 17], [18, 19]),
             'ignore_label': 255,
             # 'seg_root': _DATA_DIR + '/Green_AI/Testing/Category_ids',  # no gt seg
             'label_shift': 0},
    }
}
